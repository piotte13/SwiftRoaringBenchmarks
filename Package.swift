...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/piotte13/SwiftRoaring.git", from: "1.0.1"),
    ],
    targets: [
        ...
        .target(
            ...
            dependencies: ["SwiftRoaring", "ccode"]),
        
        .testTarget(
            name: "SwiftRoaringBenchmarksTests",
            dependencies: ["SwiftRoaringBenchmarks"]),
    ]
)
